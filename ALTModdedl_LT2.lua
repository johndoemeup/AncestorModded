...
local lib=loadstring(game:HttpGet('https://raw.githubusercontent.com/johndoemeup/AncestorModded/main/AncestorUILibmod'))();
local requirements={
    ConfigSetup={
    AlwaysDay=false, 
    AlwaysNight=false,
...
MainGameOptions:Toggle(
    'Funtime Loop Bring Boulders To Player',
    function(state)
        if state then
